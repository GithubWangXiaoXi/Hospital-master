            ...
            <div class="login">
                <div class="my-doctor">
                    ...
                    <div style="float: right;line-height:42px;margin-left:15px">
                        ...
                        <div style="position: absolute;top: 0px;left: 265px">
                        ...
                        <div style="position: absolute;top: 0px;left: 340px">
                            <a href="${pageContext.request.contextPath}/mms/login.jsp">
                                <input type="button" value="医&nbsp;生&nbsp;入&nbsp;口" style="width:60px;height:40px;cursor:pointer;border: 1px solid #2896f3;color:#2896f3;"></input>
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <div class="footer-con">
        <div class="footer-info-url">
            <dd class="fo-link">
                ...
                <a href="#" target="_blank"><span>©2018 Mstanford &nbsp;&nbsp;隐私条款</span></a>
            </dd>
        </div>
    </div>
</footer>
