                    ...
                    <TR>
                        <TD>
                            <TABLE id=grid
                                ...
                                <% List<Medicine> allMedicine = (List<Medicine>)session.getAttribute("allMedicine"); %>
                                <%for (int i=0;i<allMedicine.size();i++){%>
                                　　　　<TR
                                        style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
                                    <TD><%out.print(allMedicine.get(i).getMno()); %></TD>
                                    <TD><%out.print(allMedicine.get(i).getMname()); %></TD>
                                    <TD><%out.print(allMedicine.get(i).getMmode()); %></TD>
                                    <TD><%out.print(allMedicine.get(i).getMefficacy()); %></TD>
                                    <TD>
