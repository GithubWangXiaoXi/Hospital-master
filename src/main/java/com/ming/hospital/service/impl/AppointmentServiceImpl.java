...
public class AppointmentServiceImpl implements AppointmentService {
    ...
    public List<Appointment> listAll() {
        ...
        appointments = appointmentMapper.selectByExample(new AppointmentExample());
        return appointments;
    }

    @Override
    public List<Appointment> getAppointmentByDoctor(Doctor doctor) {
        return appointmentMapper.getAppointmentByDid(Integer.valueOf(doctor.getDid().toString()));
    }
}
