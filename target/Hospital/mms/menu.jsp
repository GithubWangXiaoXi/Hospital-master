				...
				<TABLE cellSpacing=0 cellPadding=3 width=165 align=center border=0>
					...
					<TR>
						<TD class=mainMenu onClick="MenuDisplay('table_1');"><SPAN
								class=span id=table_1Span>＋</SPAN> 信息查询</TD>
					</TR>
					<TR>
						<TD>
							<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
								...
								<TBODY>
								<TR>
									<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/Prescription/isDoctorLogin"
														   target=main>－ 查询处方信息</A></TD>
								</TR>
								<TR>
									<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/Medicine/isDoctorLogin"
														   target=main>－ 查询药品信息</A></TD>
								</TR>
					...
					<TR>
						<TD class=mainMenu onClick="MenuDisplay('table_2');"><SPAN
								class=span id=table_2Span>＋</SPAN> 信息修改</TD>
					</TR>
					<TR>
						<TD>
							<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
								...
								<TBODY>
								<TR>
									<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/Prescription/QueryAllPrescription1"
														   target=main>－ 修改处方信息</A></TD>
								</TR>
								</TBODY>
							</TABLE>
						</TD>
					...
					<TR>
						<TD class=mainMenu onClick="MenuDisplay('table_5');"><SPAN
								class=span id=table_5Span>＋</SPAN> 信息浏览</TD>
					</TR>
					<TR>
						<TD>
							<TABLE id=table_5 style="DISPLAY: none" cellSpacing=0
								...
								<TBODY>
								<TR>
									<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/Prescription/QueryAllPrescription"
														   target=main>－浏览处方信息</A></TD>
								</TR>
								<TR>
									<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/Medicine/GetAllMedicine"
														   target=main>－浏览药品信息</A></TD>
								</TR>
					...
					<%--<TR>--%>
						<%--<TD>--%>
							<%--<TABLE id=table_4 style="DISPLAY: none" cellSpacing=0--%>
								...
								<%--<TBODY>--%>
								<%--<TR>--%>
									<%--<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/customer_custLevelCount.action"--%>
														   <%--target=main>－客户级别统计</A></TD>--%>
								<%--</TR>--%>
								<%--<TR>--%>
									<%--<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/customer_custSourceCount.action"--%>
