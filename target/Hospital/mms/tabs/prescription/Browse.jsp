                    ...
                    <TR>
                        <TD>
                            <TABLE id=grid
                                ...
                                <% List<Prescription> allPrescription = (List<Prescription>)session.getAttribute("allPrescription"); %>
                                <%for (int i=0;i<allPrescription.size();i++){%>
                                　　　　<TR
                                        style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
                                    <TD><%out.print(allPrescription.get(i).getPid()); %></TD>
                                    <TD><%out.print(allPrescription.get(i).getAppointment().getName()); %></TD>
                                    <TD><%out.print(allPrescription.get(i).getDescription()); %></TD>
                                    <TD><%out.print(allPrescription.get(i).getMedicineMname()); %></TD>
                                    <TD>
                                ...
                                <%--<TD>--%>
                                <%--<a href="customer_delete.action">删除</a>--%>
                                <%--<a href="customer_update.action">修改</a>--%>
                                <%--</TD>--%>
                                <%--</TR>--%>
